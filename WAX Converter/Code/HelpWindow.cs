...
namespace WAX_converter
{
    class HelpWindow : Form
    {
        ...
        public HelpWindow() 
        {
            ...
            helpText[8] = "4. Build sequences from frames. Each sequence can have up to 32 frames";
            helpText[9] = "5. Assign sequences to actions";
